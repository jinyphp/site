                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="page-header-title">
                                <i class="bi bi-translate me-2"></i>언어 상세정보
                            </h1>
                            <p class="page-header-subtitle">{{ $language->name }}의 상세 정보를 확인합니다.</p>
                        </div>
                        <div>
                            <a href="{{ route('admin.cms.language.edit', $language->id) }}" class="btn btn-warning me-2">
        ...
        <div class="col-xl-3 col-lg-6 col-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="fw-bold">{{ $stats['total_languages'] }}</h4>
                            <p class="text-muted mb-0">전체 언어</p>
                        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="fw-bold">{{ $stats['active_languages'] }}</h4>
                            <p class="text-muted mb-0">활성 언어</p>
                        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="fw-bold">{{ $language->order ?? 0 }}</h4>
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-4">
                                <label class="form-label fw-bold">언어 코드</label>
                                <div class="p-3 bg-light rounded">
                                    <span class="badge bg-primary fs-6">{{ $language->lang }}</span>
                                </div>
                            </div>

                            <div class="mb-4">
                                <label class="form-label fw-bold">언어명</label>
                                <div class="p-3 bg-light rounded">
                                    {{ $language->name ?: '-' }}
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold">로케일</label>
                                <div class="p-3 bg-light rounded">
                                    {{ $language->locale ?: '-' }}
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <div class="p-3 bg-light rounded">
                                    @if($language->flag)
                                        ...
                                        <span class="ms-2">{{ $language->flag }}</span>
                                    @else
                            ...
                            <div class="mb-4">
                                ...
                                <div class="p-3 bg-light rounded">
                                    @if($language->is_default)
                                        <span class="badge bg-warning me-2">기본 언어</span>
                                    @endif
                                    @if($language->enable)
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <a href="{{ route('admin.cms.language.index') }}" class="btn btn-outline-secondary me-2">
                                <i class="fe fe-list me-2"></i>목록
                            </a>
                        </div>
                        <div>
                            @if($stats['can_delete'])
                                <form action="{{ route('admin.cms.language.destroy', $language->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger" onclick="return confirm('정말로 {{ $language->name }} 언어를 삭제하시겠습니까?\n\n이 작업은 되돌릴 수 없습니다.')">
        ...
        <div class="col-xl-4 col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h6>언어 코드</h6>
                    <p class="text-muted small mb-3">ISO 639-1 표준을 따르는 2글자 언어 코드입니다.</p>

                    <h6>기본 언어</h6>
                    <p class="text-muted small mb-3">시스템의 기본 언어는 삭제하거나 비활성화할 수 없습니다.</p>
                    ...
                    <ul class="text-muted small mb-0">
                        <li><strong>기본</strong>: 시스템 기본 언어</li>
                        <li><strong>활성</strong>: 사용 가능한 언어</li>
                        <li><strong>비활성</strong>: 사용 불가능한 언어</li>
                    </ul>
                </div>
            </div>
        </div>
