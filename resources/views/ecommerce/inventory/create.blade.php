...
<div class="container-fluid">
    ...
    <!-- 재고 등록 폼 -->
    <form method="POST" action="{{ route('admin.site.ecommerce.inventory.store') }}">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror"
                                          ...
                                          name="notes"
                                          rows="3"
                                          placeholder="재고에 대한 추가 정보나 메모를 입력하세요">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-2 d-flex justify-content-between">
                            <span>보유 수량:</span>
                            <span id="summary-quantity" class="fw-bold">0</span>
                        </div>
                        <div class="mb-2 d-flex justify-content-between">
                            <span>예약 수량:</span>
                            <span id="summary-reserved" class="text-muted">0</span>
                        </div>
                        <hr class="my-2">
                        <div class="mb-2 d-flex justify-content-between">
                            <span>사용 가능:</span>
                            <span id="summary-available" class="fw-bold text-primary">0</span>
                        </div>
                        <div class="mb-2 d-flex justify-content-between">
                            <span>총 가치:</span>
                            <span id="summary-value" class="fw-bold text-success">₩0</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fe fe-save me-2"></i>재고 등록
                            </button>
                            <a href="{{ route('admin.site.ecommerce.inventory.index') }}" class="btn btn-outline-secondary">
