<!-- Career Footer - White with detailed links -->
    ...
    <div class="container mt-lg-2">
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <!-- about company -->
                <div class="mb-4">
                    <img src="{{ asset('assets/images/brand/logo/logo.svg') }}" alt="Jiny" class="logo-inverse" />
                    <div class="mt-4">
        ...
        <div class="row align-items-center g-0 border-top py-2 mt-6">
            ...
            <div class="col-lg-4 col-md-5 col-12">
                <span>© 2022 Jiny-Academy. All Rights Reserved</span>
            </div>
