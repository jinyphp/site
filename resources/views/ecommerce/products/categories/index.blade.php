...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('admin.site.products.categories.create') }}" class="btn btn-primary">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.site.products.categories.index') }}">
                <div class="row">
                    <div class="col-md-4">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Product Categories 목록</h5>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        @endif
                                        <div>
                                            <a href="{{ route('admin.site.products.categories.show', $category->id) }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-danger small">
                    ...
                    하위 카테고리나 관련 상품이 있으면 삭제할 수 없습니다.
                </p>
            </div>
