<a data-bs-target="#menu-{{$code}}-{{$ref}}-{{$i}}" data-bs-toggle="collapse" class="sidebar-link">
    ...
    <ul id="menu-{{$code}}-{{$ref}}-{{$i}}"
        ...
        <li class="sidebar-item">
            <a class="sidebar-link" href="/forms-layouts">
                Form Layouts <span class="sidebar-badge badge bg-primary">Pro</span>
            </a>
            </li>
        <li class="sidebar-item">
            <a class="sidebar-link" href="/forms-input-groups">
                Input Groups <span class="sidebar-badge badge bg-primary">Pro</span>
            </a>
        </li>
    </ul>
@endif
...
<div class="collapse show" id="menu-{{$code}}-{{$ref}}-{{$i}}" style="">
    @if(isset($item['items']))
    <ul style="list-style-type: none; border-left:1px solid; border-color: #ccc; padding-left: 1rem;">
        @includeIf("jiny-site::site.menus.sidebar.style1.node",[
            'ref' => $ref."-".$i,
            'rows' => $item['items']
        ])
