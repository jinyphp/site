    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0">Location 수정</h1>
                    <p class="text-muted">위치 정보를 수정합니다.</p>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.cms.about.location.update', $location->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                       id="title" name="title" value="{{ old('title', $location->title) }}" required
                            ...
                            <div class="col-12">
                                ...
                                <input type="url" class="form-control @error('image') is-invalid @enderror"
                                       id="image" name="image" value="{{ old('image', $location->image) }}"
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="위치에 대한 자세한 설명을 입력하세요.">{{ old('description', $location->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
