...
@section('title', '새 콘텐츠 블럭 추가: ' . $page->title)
...
<div class="container-fluid p-6">
                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">블럭 추가</li>
                                </ol>
                            </nav>
                        </div>
                        <div>
    ...
    <form method="POST" action="{{ route('admin.cms.pages.content.store', $page->id) }}">
        @csrf
        <div class="row">
            <!-- 메인 콘텐츠 -->
            <div class="col-lg-8">
