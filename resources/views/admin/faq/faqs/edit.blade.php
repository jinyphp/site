    ...
    <div class="row">
        <div class="col-xl-10 col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.cms.faq.faqs.update', $faq->id) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="category" class="form-select @error('category') is-invalid @enderror">
                                        ...
                                        <option value="{{ $category->code }}" {{ old('category', $faq->category) == $category->code ? 'selected' : '' }}>
                                            {{ $category->title }}
                                        </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" name="enable" class="form-check-input" id="enable"
                                       value="1" {{ old('enable', $faq->enable) ? 'checked' : '' }}>
