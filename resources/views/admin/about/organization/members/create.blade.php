    ...
    <div class="row">
        <div class="col-12">
                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-1">
                            ...
                            <li class="breadcrumb-item active">새 팀원 추가</li>
                        </ol>
                    </nav>
                    <h1 class="h3 mb-0">새 팀원 추가</h1>
                    <p class="text-muted">{{ $organization->name }}에 새로운 팀원을 추가합니다.</p>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.cms.about.organization.members.store', $organization->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('bio') is-invalid @enderror"
                                          ...
                                          placeholder="팀원의 경력, 전문분야, 소개 등을 입력하세요.">{{ old('bio') }}</textarea>
                                @error('bio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
