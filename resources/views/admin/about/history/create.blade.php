    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0">새 연혁 추가</h1>
                    <p class="text-muted">회사의 새로운 연혁을 등록합니다.</p>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.cms.about.history.store') }}">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="enable" name="enable" value="1" checked>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('subtitle') is-invalid @enderror"
                                          ...
                                          placeholder="연혁에 대한 자세한 설명을 입력하세요.">{{ old('subtitle') }}</textarea>
                                @error('subtitle')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
