        ...
        <div class="row justify-content-center text-center">
            <div class="col-12 col-md-12 col-xl-8 px-0">
                <nav class="nav nav-footer justify-content-center">
                    ...
                    @else
                        ...
                        <a class="nav-link" href="#">피드백 보내기</a>
                        <a class="nav-link" href="/terms">이용약관</a>
                        <a class="nav-link" href="/help">지원받기</a>
                    @endif
                </nav>
            </div>
                ...
                <div class="my-6">
                    @if (!empty($social))
                        @foreach ($social as $socialLink)
                            <a href="{{ $socialLink['url'] }}" target="_blank" rel="noopener" class="me-4">
            ...
            <div class="col-lg-8 col-md-12 col-12">
                <span>
                    ...
                    <span id="copyright3">
                        <script>
                            document.getElementById('copyright3').appendChild(document.createTextNode(new Date().getFullYear()))
                        </script>
                    </span>
