        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="mb-4">
                    ...
                    @endif
                    <div class="mt-4">
                        <p>{{ $company['description'] ?? 'Geek은 Bootstrap 반응형 프레임워크로 제작된 개발자를 위한 풍부한 기능과 아름다운 Bootstrap UIKit입니다.' }}</p>
                        <!-- social media -->
                        <div class="fs-4 mt-4">
                            @if(!empty($social))
                                @foreach($social as $socialLink)
                                    <a href="{{ $socialLink['url'] }}" class="me-2" target="_blank" rel="noopener">
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-unstyled nav nav-footer flex-column nav-x-0">
                        ...
                        @else
                            ...
                            <li><a href="/tutorials" class="nav-link">튜토리얼</a></li>
                        @endif
                    </ul>
                </div>
            </div>
        ...
        <div class="row align-items-center g-0 border-top py-2 mt-6">
            ...
            <div class="col-lg-4 col-md-5 col-12">
                <span>
                    ...
                    {{ $copyright ?: 'Geeks-UI, Inc. All Rights Reserved' }}
                </span>
            </div>
                ...
                <nav class="nav nav-footer">
                    @if(!empty($legalSection['links']))
                        @foreach($legalSection['links'] as $index => $link)
                            <a class="nav-link {{ $index === 0 ? 'ps-0' : 'px-2 px-md-3' }}" href="{{ $link['href'] }}">{{ $link['title'] }}</a>
                        @endforeach
                    @else
                        <!-- Fallback legal links -->
                        <a class="nav-link ps-0" href="/privacy">개인정보처리방침</a>
                        <a class="nav-link px-2 px-md-3" href="/cookies">쿠키 정책</a>
