                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="page-header-title">
                                <i class="bi bi-globe2 me-2"></i>국가 추가
                            </h1>
                            <p class="page-header-subtitle">새로운 국가를 시스템에 추가합니다.</p>
                        </div>
                        <div>
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.cms.country.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              name="description"
                                              rows="3"
                                              placeholder="국가에 대한 설명을 입력하세요">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
