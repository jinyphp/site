<div class="dropdown d-none d-md-block nav">
    ...
    <a class="nav-link dropdown-toggle py-1 px-0" href="javascript:void(0);" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Country select: USA">
  ...
  <ul class="dropdown-menu fs-sm" style="--cz-dropdown-spacer: .5rem">
    ...
    <li>
      <a class="dropdown-item" href="javascript:void(0);" wire:click="choose('{{$item['code']}}')">
