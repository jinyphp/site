...
/**
 * Admin Board Related Controller
 *
 * 관련글을 관리하는 컨트롤러입니다.
 */
class AdminBoardRelated extends Controller
{
    /**
     * 테이블명
     */
     ...
     * 뷰 경로
     */
    protected $viewPath = 'jiny-site::admin.board_related';
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.cms.board.related')
