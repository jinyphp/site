                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('features') is-invalid @enderror"
                                          ...
                                          name="features"
                                          rows="4"
                                          placeholder='JSON 형식으로 입력하세요. 예: ["기능1", "기능2", "기능3"]'>{{ old('features', $pricing->features) }}</textarea>
                                @error('features')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('limitations') is-invalid @enderror"
                                          ...
                                          name="limitations"
                                          rows="3"
                                          placeholder='JSON 형식으로 입력하세요. 예: ["제한사항1", "제한사항2"]'>{{ old('limitations', $pricing->limitations) }}</textarea>
                                @error('limitations')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('currency') is-invalid @enderror"
                                    ...
                                    name="currency"
                                    required>
                                <option value="KRW" {{ old('currency', $pricing->currency) === 'KRW' ? 'selected' : '' }}>KRW (원)</option>
                                <option value="USD" {{ old('currency', $pricing->currency) === 'USD' ? 'selected' : '' }}>USD (달러)</option>
                                <option value="EUR" {{ old('currency', $pricing->currency) === 'EUR' ? 'selected' : '' }}>EUR (유로)</option>
                                <option value="JPY" {{ old('currency', $pricing->currency) === 'JPY' ? 'selected' : '' }}>JPY (엔)</option>
                            </select>
                            @error('currency')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('billing_period') is-invalid @enderror"
                                ...
                                <option value="monthly" {{ old('billing_period', $pricing->billing_period) === 'monthly' ? 'selected' : '' }}>월간</option>
                                <option value="yearly" {{ old('billing_period', $pricing->billing_period) === 'yearly' ? 'selected' : '' }}>연간</option>
                                <option value="weekly" {{ old('billing_period', $pricing->billing_period) === 'weekly' ? 'selected' : '' }}>주간</option>
                            </select>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number"
                                   ...
                                   id="min_quantity"
                                   name="min_quantity"
                                   value="{{ old('min_quantity', $pricing->min_quantity) }}"
                                   min="1"
                                   required>
                            @error('min_quantity')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number"
                                   ...
                                   id="max_quantity"
                                   name="max_quantity"
                                   value="{{ old('max_quantity', $pricing->max_quantity) }}"
                                   min="1">
                            @error('max_quantity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="card-body">
                        <div class="form-check">
                            <input class="form-check-input"
                                   ...
                                   name="enable"
                                   value="1"
                                   {{ old('enable', $pricing->enable) ? 'checked' : '' }}>
