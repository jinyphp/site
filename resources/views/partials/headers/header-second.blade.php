    ...
    <div class="container-fluid px-0">
        ...
        <div class="order-lg-3">
            <div class="d-flex align-items-center">
                ...
                <a href="#" class="btn btn-outline-primary ms-2 d-none d-lg-block">Sign in</a>
                <a href="#" class="btn btn-primary ms-2 d-none d-lg-block">Sign up</a>
                <!-- Button -->
                            ...
                            <div class="row">
                                    ...
                                    <div>
                                        <a href="#">
                                            <div class="d-flex mb-3">
                                                <img src="{{ asset('assets/images/png/degree-1.png') }}"
                                                    alt="" />
                                                <div class="ms-2">
                                        ...
                                        <a href="#">
                                            <div class="d-flex mb-3">
                                                <img src="{{ asset('assets/images/png/degree-2.png') }}"
                                                    alt="" />
                                                <div class="ms-2">
                                        ...
                                        <a href="#">
                                            <div class="d-flex mb-3">
                                                <img src="{{ asset('assets/images/png/degree-3.png') }}"
                                                    alt="" />
                                                <div class="ms-2">
                                        ...
                                        <a href="#">
                                            <div class="d-flex mb-3">
                                                <img src="{{ asset('assets/images/png/degree-4.png') }}"
                                                    alt="" />
                                                <div class="ms-2">
                                        ...
                                        <div class="mt-4">
                                            <a href="#" class="btn btn-outline-primary btn-sm">View all
                                                degree</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-12 mt-4 mt-lg-0">
                                    ...
                                    <div>
                                        <a href="#">
                                            <div class="d-flex mb-3">
                                                <img src="{{ asset('assets/images/png/google.png') }}"
                                                    alt="" />
                                                <div class="ms-2">
                                        ...
                                        <a href="#">
                                            <div class="d-flex mb-3">
                                                <img src="{{ asset('assets/images/png/microsoft.png') }}"
                                                    alt="" />
                                                <div class="ms-2">
                                        ...
                                        <a href="#">
                                            <div class="d-flex mb-3">
                                                <img src="{{ asset('assets/images/png/tensorflow.png') }}"
                                                    alt="" />
                                                <div class="ms-2">
                                        ...
                                        <a href="#">
                                            <div class="d-flex mb-3">
                                                <img src="{{ asset('assets/images/png/meta.png') }}" alt="" />
                                                <div class="ms-2">
                                                    <small class="text-body">University of Colorado</small>
