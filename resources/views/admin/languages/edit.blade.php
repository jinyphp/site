                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="page-header-title">
                                <i class="bi bi-translate me-2"></i>언어 수정
                            </h1>
                            <p class="page-header-subtitle">언어 정보를 수정합니다.</p>
                        </div>
                        <div>
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.cms.language.update', $language->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              name="description"
                                              rows="3"
                                              placeholder="언어에 대한 설명을 입력하세요">{{ old('description', $language->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           id="manager"
                                           name="manager"
                                           value="{{ old('manager', $language->manager ?? 'System') }}"
                                           placeholder="관리자명">
                                    @error('manager')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                           ...
                                           id="order"
                                           name="order"
                                           value="{{ old('order', $language->order ?? 0) }}"
                                           min="0">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input type="checkbox"
                                                   ...
                                                   name="enable"
                                                   value="1"
                                                   {{ old('enable', $language->enable) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <div>
                                ...
                                <a href="{{ route('admin.cms.language.show', $language->id) }}" class="btn btn-info me-2">
