            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-lb-tab mb-6 bg-gray-200 px-5 rounded-3" id="pills-tab" role="tablist">
                        ...
                        <!-- nav item -->
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="pills-marketing-tab" data-bs-toggle="pill" href="#pills-marketing"
                                role="tab" aria-controls="pills-marketing" aria-selected="false">
                                Marketing
                            </a>
                        </li>
                        <!-- nav item -->
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="pills-business-tab" data-bs-toggle="pill" href="#pills-business"
                                role="tab" aria-controls="pills-business" aria-selected="false">
                                Business
                            </a>
                        </li>
                        <!-- nav item -->
                        ...
                        <div class="tab-pane fade show active" id="pills-development" role="tabpanel"
                            ...
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                                <div class="col">
                                    ...
                                    <div class="card card-hover">
                                        <a href="../course-single.html"><img
                                                src="../../assets/images/course/course-javascript.jpg" alt="course"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h4 class="mb-2 text-truncate-line-2"><a href="../course-single.html"
                                                    class="text-inherit">How to easily create a website with JavaScript</a>
                                            </h4>
                                ...
                                <div class="col">
                                    ...
                                    <div class="card card-hover">
                                        <a href="../course-single.html"><img
                                                src="../../assets/images/course/course-css.jpg" alt="course"
                                                class="card-img-top" /></a>
                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <div class="card card-hover">
                                        <a href="../course-single.html"><img
                                                src="../../assets/images/course/course-gatsby.jpg" alt="course"
                                                class="card-img-top" /></a>
                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <h4 class="mb-2 text-truncate-line-2"><a href="../course-single.html"
                                                    class="text-inherit">The Gatsby Course: build web application</a></h4>
                                ...
                                <div class="col">
                                    ...
                                    <div class="card card-hover">
                                        <a href="../course-single.html"><img
                                                src="../../assets/images/course/course-wordpress.jpg" alt="course"
                                                class="card-img-top" /></a>
                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <div class="card card-hover">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h4 class="mb-2 text-truncate-line-2"><a href="../course-single.html"
                                                    class="text-inherit">How to easily create a website with React</a></h4>
                                            <!-- List -->
                                ...
                                <div class="col">
                                    ...
                                    <div class="card card-hover">
                                        <a href="../course-single.html"><img
                                                src="../../assets/images/course/course-graphql.jpg" alt="course"
                                                class="card-img-top" /></a>
                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <h4 class="mb-2 text-truncate-line-2"><a href="../course-single.html"
                                                    class="text-inherit">GraphQL: introduction to graphQL for beginners</a>
                                            </h4>
                                ...
                                <div class="col">
                                    ...
                                    <div class="card card-hover">
                                        <a href="../course-single.html"><img
                                                src="../../assets/images/course/course-angular.jpg" alt="course"
                                                class="card-img-top" /></a>
                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <h4 class="mb-2 text-truncate-line-2"><a href="../course-single.html"
                                                    class="text-inherit">Angular - the complete guide for beginner</a></h4>
                                ...
                                <div class="col">
                                    ...
                                    <div class="card card-hover">
                                        <a href="../course-single.html"><img
                                                src="../../assets/images/course/course-python.jpg" alt="card"
                                                class="card-img-top" /></a>
                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <h4 class="mb-2 text-truncate-line-2"><a href="../course-single.html"
                                                    class="text-inherit">The Python Course: build web application</a></h4>
                        ...
                        <div class="tab-pane fade" id="pills-design" role="tabpanel" aria-labelledby="pills-design-tab">
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                                ...
                                <div class="col">
                                    ...
                                    <div class="card card-hover">
                                        <a href="../course-single.html"><img
                                                src="../../assets/images/course/course-python.jpg" alt="course"
                                                class="card-img-top" /></a>
                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
