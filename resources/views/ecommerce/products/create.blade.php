...
<div class="container-fluid">
    ...
    <!-- 상품 등록 폼 -->
    <form method="POST" action="{{ route('admin.site.products.store') }}">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('specifications') is-invalid @enderror"
                                          ...
                                          name="specifications"
                                          rows="4"
                                          placeholder="JSON 형식으로 입력하세요. 예: {&quot;크기&quot;: &quot;100x50cm&quot;, &quot;무게&quot;: &quot;2kg&quot;}">{{ old('specifications') }}</textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            @error('price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">기본 가격입니다. 상품 등록 후 상세한 가격 옵션을 추가할 수 있습니다.</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @error('sale_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">기본 할인가입니다. 상품 등록 후 상세한 할인 옵션을 추가할 수 있습니다.</div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input"
                                           ...
                                           value="1"
                                           {{ old('enable_purchase', true) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input"
                                           ...
                                           name="enable_contact"
                                           value="1"
                                           {{ old('enable_contact', true) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input"
                                           ...
                                           value="1"
                                           {{ old('enable_social_share', true) ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fe fe-save me-2"></i>상품 등록
                            </button>
                            <a href="{{ route('admin.site.products.index') }}" class="btn btn-outline-secondary">
