    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0">새 조직 추가</h1>
                    <p class="text-muted">새로운 조직을 등록합니다.</p>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.cms.about.organization.store') }}">
                        @csrf
                        ...
                        <div class="row g-4">
                                ...
                                <select class="form-select @error('parent_id') is-invalid @enderror"
                                    ...
                                    @foreach($parentOptions as $option)
                                        <option value="{{ $option['id'] }}"
                                                ...
                                                {{ ($selectedParentId == $option['id'] || old('parent_id') == $option['id']) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                       id="sort_order" name="sort_order" value="{{ old('sort_order', $nextSortOrder) }}" min="0">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="조직의 역할과 업무에 대한 설명을 입력하세요.">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('manager_title') is-invalid @enderror"
                                       id="manager_title" name="manager_title" value="{{ old('manager_title') }}"
