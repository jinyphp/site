...
<nav class="navbar navbar-expand-lg">
    <div class="container px-0">
        <a class="navbar-brand" href="#"><img src="{{ asset('assets/images/brand/logo/logo.svg') }}" alt="Geeks" style="height: 1.875rem" /></a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarPages">
                        <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="#" class="dropdown-item">All Courses</a>
                                </li>
                                <li>
                                    <a href="#" class="dropdown-item">Course Category</a>
                                </li>
                                <li>
                                    <a href="#" class="dropdown-item">Category Single</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="#" class="dropdown-item">Instructor</a>
                                </li>
                                <li>
                        ...
                        <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="#" class="dropdown-item">All Post</a>
                                </li>
                                <li>
