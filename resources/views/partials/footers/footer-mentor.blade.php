            ...
            <div class="col-lg-4 col-12">
                ...
                <div class="d-flex flex-column gap-4">
                    <div>
                        ...
                        @else
                            <img src="{{ asset('assets/images/mentor/geeks-mentor.svg') }}" alt="Geeks"
                                class="" />
                        @endif
                    </div>
                    <div>
                        <p class="mb-0 txet-gray-500">
                            {{ $company['description'] ?? '창업자와 마케터를 진정으로 사람을 돕는 것을 즐기는 경험 풍부한 멘토들과 연결합니다.' }}</p>
                    </div>
                    <!-- Social Media -->
            ...
            @foreach ($sectionConfigs as $config)
                <div class="col-lg-2 col-md-3 col-6">
                    <div class="d-flex flex-column gap-2">
                        ...
                        @endphp
                        <!-- list -->
                        <h5 class="fw-bold text-white-50 text-uppercase mb-0">
                            {{ $section['title'] ?? $config['title'] }}</h5>
