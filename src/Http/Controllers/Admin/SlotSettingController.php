...
class SlotSettingController extends ConfigController
{
    public function __construct()
    {
        ...
        ##
        $this->actions['filename'] = "jiny/site/slot"; // 설정파일명(경로)

        $this->actions['view']['main'] = "jiny-site::admin.slot.layout-php";
        //$this->actions['view']['form'] = "jiny-site::admin.slot.form";
        $this->actions['view']['list'] = "jiny-site::admin.slot.list";

        $this->actions['view']['form'] = "jiny-site::admin.slot.form";

        $this->actions['title'] = "슬롯설정";
