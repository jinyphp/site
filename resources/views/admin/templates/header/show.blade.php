        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.cms.templates.header.edit', $header['id']) }}" class="btn btn-primary me-2">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $header['description'] ?? '설명 없음' }}</td>
                                        </tr>
                                        <tr>
                            ...
                            <h6 class="text-muted mb-3 mt-4">헤더 옵션</h6>

                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div class="card border-primary">
                                        <div class="card-header bg-primary text-white py-2">
                                            <h6 class="mb-0"><i class="fas fa-bars"></i> 네비게이션 바</h6>
                                        </div>
                                        <div class="card-body py-3 text-center">
                                            @if(!empty($header['navbar']))
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card border-secondary">
                                        <div class="card-header bg-secondary text-white py-2">
                                            <h6 class="mb-0"><i class="fas fa-image"></i> 로고</h6>
                                        </div>
                                        <div class="card-body py-3 text-center">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card border-info">
                                        <div class="card-header bg-info text-white py-2">
                                            <h6 class="mb-0"><i class="fas fa-search"></i> 검색</h6>
                                        </div>
                                        <div class="card-body py-3 text-center">
                                            @if(!empty($header['search']))
                                                <span class="badge bg-success fs-6">Yes</span>
                                            @else
                                                <span class="badge bg-secondary fs-6">No</span>
                                            @endif
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card bg-light">
                                ...
                                <div class="card-body">
                                    <pre><code class="language-json">{{ json_encode($header, JSON_PRETTY_PRINT) }}</code></pre>
                                </div>
                            </div>
                            ...
                            <div class="card bg-light mt-3">
                                ...
                                <div class="card-body">
                                    <pre><code class="language-php">{{ json_encode($header, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</code></pre>
                                </div>
                            </div>
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="{{ route('admin.cms.templates.header.edit', $header['id']) }}"
                                           class="btn btn-outline-primary btn-sm">
                                            <i class="bi bi-pencil-square"></i> 헤더 수정
                                        </a>
...
$header = collect($headers)->firstWhere('header_key', '{{ addslashes($header['header_key']) }}');</code></pre>
                            ...
                            <div class="alert alert-warning">
                                ...
                                <p class="mb-2">이 헤더는 다음 템플릿을 사용합니다:</p>
                                <ul class="mb-0">
                                    <li><strong>템플릿:</strong> <code>{{ $header['template'] }}</code></li>
                                </ul>
...
function copyToClipboard(text) {
    navigator.clipboard.writeText(text).then(function() {
        ...
        alert.innerHTML = '<i class="fas fa-check"></i> 헤더 키가 클립보드에 복사되었습니다';
